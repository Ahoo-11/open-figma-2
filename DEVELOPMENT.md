...
```bash
git remote add encore encore://open-figma-design-tool-xhwi
```
...
Monitor your deployment progress in the [Encore Cloud dashboard](https://app.encore.dev/open-figma-design-tool-xhwi/deploys).
...
2. Navigate to Encore Cloud [GitHub Integration settings](https://app.encore.cloud/open-figma-design-tool-xhwi/settings/integrations/github)
